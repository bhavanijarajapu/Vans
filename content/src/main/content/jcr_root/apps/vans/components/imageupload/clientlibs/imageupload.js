...
(function (Granite, $, SCFConsole) {
    ...
    $(document).ready(function () {
        $(".scf-js-social-console-imageupload").each(function (key, value) {
            console.log($(this));
            console.log($(this).find(".scf-js-social-console-imgUploadPreview"));
            var imgSrc = $(this).find(".scf-js-social-console-imgUploadPreview").attr('src');
            //console.log(imagSrc);
            console.log("=============== inside image src check ============");
            if (imgSrc) {
            ...
            $('#propertiesform').on("submit", function () {
                ...
                $(this).find("input[type=\"file\"]").each(function () {
                    ...
                    console.log($(this).attr("data-file-added"));
